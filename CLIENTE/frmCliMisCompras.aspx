...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="compras-container">
        ...
        <div class="page-header">
            <asp:Label ID="lblConsultas" runat="server" Text="Mis Reservas"></asp:Label>
            <asp:Label ID="MainContent_lblSes" runat="server" ClientIDMode="Static"></asp:Label>
        </div>

        <!-- HISTORIAL -->
        <div class="section-card">
            <div class="section-title">Historial de Reservas</div>
        ...
        <!-- DETALLE -->
        <div class="section-card">
            <asp:Label ID="lblDet" runat="server" Text="Detalle de la Reserva" CssClass="section-title"></asp:Label>
